    ...
    <div className="bg-[#F1F1F1] -mt-40 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:-mt-8 pb-40">
          {/* Single card */}
          <a
            href="https://github.com/jdraper7/CPSC4900-OddandEven-Team5"
          ...
          {/* Single card */}
          <a
            href="https://drive.google.com/file/d/1LUkBJuId872Axkp2EULuwj34ia9lxP7q/view?usp=sharing"
